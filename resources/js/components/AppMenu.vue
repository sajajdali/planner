...
const items = [
    ...
    { label: 'یادداشت‌ها', path: '/notes', color: '#9B5DE5', icon: 'M4 4h13a3 3 0 013 3v13H7a3 3 0 01-3-3V4zM8 8h8M8 12h8M8 16h5' },
...
<style scoped>
.app-menu-wrap{position:relative;display:inline-flex;z-index:5002}.shared-menu-button{position:relative;z-index:92;width:42px;height:40px;border:3px solid #3a2e1f;border-radius:12px;background:#fff;display:flex;flex-direction:column;justify-content:center;gap:5px;padding:0 9px;box-shadow:3px 3px 0 #3a2e1f;cursor:pointer}.shared-menu-button span{height:4px;background:#3a2e1f;border-radius:999px}.shared-menu-button.active{background:#ffd93d}.shared-menu-backdrop{position:fixed;inset:0;z-index:90;display:block;border:0;background:rgba(20,14,28,.42);backdrop-filter:blur(3px);cursor:pointer}.shared-drawer{position:absolute;top:52px;left:0;z-index:91;display:grid;gap:8px;min-width:260px;padding:12px;border:3px solid #3a2e1f;border-radius:16px;background:#fffaf0;box-shadow:6px 6px 0 #3a2e1f}.shared-user{display:flex;align-items:center;gap:10px;min-width:0;margin:0 4px 10px;padding:8px 9px;border:1px solid rgba(234,223,190,.62);border-radius:16px;background:rgba(255,255,255,.46);box-shadow:inset 0 0 0 1px rgba(255,255,255,.65)}.shared-drawer .shared-user i{width:58px;height:58px;border:2px solid #3a2e1f;border-radius:999px;background:#fffaf0;display:grid;place-items:center;overflow:hidden;flex-shrink:0;box-shadow:2px 2px 0 rgba(58,46,31,.82),0 0 0 4px rgba(255,217,61,.18);padding:3px;box-sizing:border-box}.shared-user img{width:100%;height:100%;border-radius:999px;object-fit:cover}.shared-user b{font-size:24px;font-style:normal}.shared-user div{min-width:0;display:grid;gap:2px;text-align:right}.shared-user strong,.shared-user small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.shared-user strong{font-size:15px;color:#3a2e1f;line-height:1.15;font-weight:900}.shared-user small{color:#9a8b6a;font-size:10px;font-weight:800;margin-top:0}.shared-drawer button{height:44px;border:0;border-radius:12px;background:color-mix(in srgb,var(--c) 16%,white);display:flex;align-items:center;gap:10px;padding:0 10px;color:#3a2e1f;font-weight:900;cursor:pointer;text-align:right}.shared-drawer button.active{outline:2px solid var(--c);background:color-mix(in srgb,var(--c) 28%,white)}.shared-drawer button i{width:30px;height:30px;border:2px solid #3a2e1f;border-radius:10px;background:var(--c);display:grid;place-items:center;flex-shrink:0;box-shadow:1px 1px 0 #3a2e1f}.shared-drawer svg{width:16px;height:16px;fill:none;stroke:#fff;stroke-width:2.2;stroke-linecap:round;stroke-linejoin:round}.shared-drawer .shared-logout{--c:#DC2626;margin-top:4px;border-top:1.5px dashed #eadfbe;border-radius:14px;background:linear-gradient(135deg,#fee2e2,#fff);color:#991b1b}.shared-drawer .shared-logout i{background:#dc2626}.shared-drawer .shared-logout:hover{background:linear-gradient(135deg,#fecaca,#fff7ed);transform:translate(-1px,-1px);box-shadow:2px 2px 0 rgba(58,46,31,.25)}
@media(max-width:640px){.shared-menu-button{width:40px;height:40px;background:#ffd93d}.shared-menu-backdrop{background:rgba(20,14,28,.54);backdrop-filter:blur(4px)}.shared-drawer{position:absolute;top:48px;left:0;right:auto;z-index:91;width:min(320px,calc(100vw - 28px));min-width:0;max-height:min(78dvh,560px);overflow:auto;transform:none;gap:7px;padding:12px;border-width:3px;border-radius:0 18px 18px 0;box-shadow:7px 7px 0 rgba(58,46,31,.96),0 18px 48px rgba(20,14,28,.3);overscroll-behavior:contain}.shared-user{min-height:68px;margin:0 4px 10px;padding:8px 9px;gap:10px;border-radius:16px}.shared-drawer .shared-user i{width:58px;height:58px;border-radius:999px}.shared-user b{font-size:24px}.shared-user strong{font-size:15px}.shared-user small{font-size:10px}.shared-drawer button{min-height:40px;height:40px;border-radius:11px;font-size:13px;gap:8px;padding:0 9px}.shared-drawer button i{width:28px;height:28px;border-width:1.5px;border-radius:9px}.shared-drawer svg{width:15px;height:15px}.shared-drawer .shared-logout{margin-top:3px;border-radius:12px}}
</style>
