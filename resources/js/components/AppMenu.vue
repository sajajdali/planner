...
@media(max-width:640px){.app-menu-wrap{position:relative;z-index:90}.shared-menu-button{width:40px;height:40px;background:#ffd93d}.shared-drawer{position:absolute;top:48px;left:0;right:auto;width:min(292px,calc(100vw - 24px));min-width:0;max-height:calc(100vh - 64px);overflow:auto;gap:5px;padding:8px;border-width:2px;border-radius:14px;box-shadow:4px 4px 0 #3a2e1f}.shared-user{min-height:42px;padding:6px 8px;gap:7px;border-radius:11px}.shared-user i{width:32px;height:32px;border-radius:10px}.shared-user b{font-size:16px}.shared-user strong{font-size:12px}.shared-user small{font-size:9px}.shared-drawer button{min-height:32px;height:32px;border-radius:9px;font-size:12px;gap:7px;padding:0 8px}.shared-drawer button i{width:24px;height:24px;border-width:1.5px;border-radius:8px}.shared-drawer svg{width:13px;height:13px}.shared-drawer .shared-logout{margin-top:2px;border-radius:10px}}
</style>
