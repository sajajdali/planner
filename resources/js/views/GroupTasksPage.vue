...
@media(max-width:720px){.team-tasks-shell{padding:18px 10px 70px}.team-paper{padding:22px 14px;transform:none}.team-head{align-items:flex-start}.project-card{padding:13px}.project-card>header{align-items:flex-start;flex-direction:column}.team-modal-backdrop{padding:12px;align-items:start;overflow:auto}.team-modal{margin:12px 0}.todo-row{gap:6px}.new-task-row input{min-width:0}}
</style>
