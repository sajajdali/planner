...
<template>
    <main class="shared-note-page" :class="{ text: note?.content_type === 'text' }" dir="rtl">
        ...
        <article v-else-if="note" class="shared-text">{{ note.content || 'بدون محتوا' }}</article>
