            ...
            <section class="notes-modal view-modal">
                <header>
                    ...
                    <button class="share-icon-btn" type="button" aria-label="کپی لینک اشتراک" title="کپی لینک اشتراک" @click="shareNote(viewNote)">
                        <svg viewBox="0 0 24 24"><path d="M8 12a4 4 0 014-4h3"></path><path d="M12 16H9a4 4 0 010-8h1"></path><path d="M14 8h1a4 4 0 010 8h-3"></path><path d="M7 17l-3 3"></path><path d="M20 4l-3 3"></path></svg>
                    </button>
