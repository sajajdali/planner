...
@media (max-width:520px){.overview-grid,.finance-cards{grid-template-columns:1fr}.day-tile{min-height:116px}.month-chip{min-width:118px}.report-shell{padding:20px 10px 40px}}
</style>
