...
const financeCalendarRef = ref<HTMLElement | null>(null);
...
async function toggleCalendar() {
    ...
    await nextTick();
    financeCalendarRef.value?.scrollIntoView({ behavior: 'smooth', block: 'start' });
}
